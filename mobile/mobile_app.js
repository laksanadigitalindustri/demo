...
(function () {
  ...
  function renderAdminControlLists() {
    if (window.SuperAdminEngine && typeof window.SuperAdminEngine.renderControlLists === 'function') {
      window.SuperAdminEngine.renderControlLists(store.invoices, store.requests, formatIDR);
    }
  }

  async function renderRegisteredUsersFullControlList() {
    if (window.SuperAdminEngine && typeof window.SuperAdminEngine.renderRegisteredUsersList === 'function') {
      await window.SuperAdminEngine.renderRegisteredUsersList(getAllRegisteredUsers());
    }
  }
